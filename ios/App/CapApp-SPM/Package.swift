...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorPushNotifications", path: "../../../node_modules/.pnpm/@capacitor+push-notifications@8.1.2_@capacitor+core@8.4.1/node_modules/@capacitor/push-notifications"),
