...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorFirebaseMessaging", path: "../../../node_modules/.pnpm/@capacitor-firebase+messaging@8.5.0_@capacitor+core@8.4.1_firebase@12.8.0/node_modules/@capacitor-firebase/messaging"),
