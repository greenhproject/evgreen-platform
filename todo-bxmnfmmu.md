...
- [x] Revisar el modelo actual de estados y las restricciones que impiden mover espacios aprobados.
- [x] Definir transiciones comerciales permitidas y permisos por rol para la gestión del pipeline.
- [x] Añadir un control de cambio de etapa accesible desde el detalle del espacio postulado.
...
- [x] Añadir pruebas tRPC que comprueben bloqueo de mutaciones administrativas para el rol comercial.
