  ...
  return <main className="mx-auto w-full max-w-6xl space-y-5 px-4 py-5 sm:px-6 lg:px-8">
    ...
    <div className="grid gap-5 xl:grid-cols-[1.3fr_0.7fr]">
      ...
      <Card><CardHeader><CardTitle>Estado operativo</CardTitle><CardDescription>Activación y diagnóstico seguro.</CardDescription></CardHeader><CardContent className="space-y-5">
        ...
        <div className="flex items-center justify-between gap-4 rounded-lg border border-border p-4"><div><p className="font-medium">Sincronización automática</p><p className="text-xs text-muted-foreground">Preparada para el outbox OCPI.</p></div><Switch checked={form.autoSync} onCheckedChange={autoSync => setForm({ ...form, autoSync })} /></div>
