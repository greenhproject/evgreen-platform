...
import { ArrowLeft, Bell, BellRing, Mail, MessageSquare, Zap, DollarSign, AlertTriangle, Send, Loader2, MapPin, Navigation, Wallet, ShieldAlert } from "lucide-react";
...
export default function UserNotifications() {
  ...
  const updateWaMut = trpc.userConfig.updateWhatsAppPreferences.useMutation({
    onMutate: async (newPrefs) => {
      // Optimistic update
      return { previousData: waPrefs.data };
    },
  ...
  const handleWaToggle = (key: "waNotifyChargeStart" | "waNotifyChargeEnd" | "waNotifyReminder" | "waNotifyPenalty" | "waNotifyWallet") => {
    ...
    const currentValue = waPrefs.data[key];
    updateWaMut.mutate({ [key]: !currentValue });
  };
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="p-4 space-y-4 pb-8">
                  ...
                  <div className="flex items-center justify-between py-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Aviso si llevas días sin cargar
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between py-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Alertas de tarifa de ocupación activa
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
          ...
          <Button className="w-full gradient-primary" onClick={handleSaveLocal}>
            Guardar preferencias de email y SMS
          </Button>
        </div>
      </div>
    </UserLayout>
