# Green EV Platform - TODO Archive

Tareas completadas archivadas para optimizar el archivo principal.
...
## Actualización de Firmware OCPP - 13 Febrero 2026
- [x] Tabla firmware_updates en BD
- [x] Handler OCPP FirmwareStatusNotification mejorado
- [x] Método updateFirmware en DualCSMS
- [x] Endpoints tRPC para firmware (upload, iniciar, historial, cancelar)
- [x] Página de gestión de firmware en panel del técnico
- [x] Entrada Firmware en menú lateral del técnico
- [x] Tests unitarios para firmware
