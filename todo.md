...
- [x] QA financiero: TypeScript limpio, 10 archivos/29 pruebas focalizadas, prueba integrada adicional Espacios→Crowdfunding y suite completa 199 archivos/2.201 pruebas aprobadas; build productivo exitoso. Render SSR confirmó los tres escenarios y clases responsive; el servicio de captura visual permaneció indisponible tras reinicio, sin impedir la validación funcional. Cero fixtures residuales y proyecto Cunduy `210001` verificado sin modificaciones durante QA.
