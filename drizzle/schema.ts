...
export const platformSettings = mysqlTable("platform_settings", {
	...
	defaultPricePerKwhAc: decimal({ precision: 10, scale: 2 }).default('800').notNull(),
	defaultPricePerKwhDc: decimal({ precision: 10, scale: 2 }).default('1200').notNull(),
	...
	costosOperativosAc: int().default(15).notNull(),
	eficienciaCargaDc: int().default(92).notNull(),
	eficienciaCargaAc: int().default(95).notNull(),
...
export const transactions = mysqlTable("transactions", {
	...
	status: mysqlEnum(['PENDING','IN_PROGRESS','COMPLETED','FAILED','CANCELLED']).default('PENDING').notNull(),
