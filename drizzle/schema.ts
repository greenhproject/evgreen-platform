...
export const siteContracts = mysqlTable("site_contracts", {
	...
	status: mysqlEnum("status", ['DRAFT', 'READY', 'DOCUSIGN_SENT', 'DOCUSIGN_COMPLETED', 'DOCUSIGN_DECLINED', 'DOCUSIGN_VOIDED', 'DOCUSIGN_EXPIRED', 'MANUAL_PDF_ISSUED', 'MANUAL_PDF_RETURNED', 'MANUAL_PDF_VERIFIED', 'MANUAL_PDF_REJECTED', 'CANCELLED']).default('DRAFT').notNull(),
...
export const siteContractParties = mysqlTable("site_contract_parties", {
	...
	role: mysqlEnum("role", ['OPERATOR', 'ALLY']).notNull(),
...
export const siteContractEvents = mysqlTable("site_contract_events", {
	...
	channel: mysqlEnum("channel", ['INTERNAL', 'DOCUSIGN', 'MANUAL_PDF']).default('INTERNAL').notNull(),
